...
contract IDO is IIDO, Ownable {
    ...
    constructor(IERC20 token, uint forSale, uint asking, uint buyingStartsAt, uint buyingEndsAt, uint vestingStartsAt, uint vestingEndsAt) {
    ...
    function contribute() external override payable {
        ...
        require(block.timestamp >= _buyingStartsAt);
        require(block.timestamp < _buyingEndsAt);
