...
contract ICO is IICO, Ownable, Pausable {
    ...
    /*
        ...
        However, once the ICO is underway, and the values are all correct, owner may decide to renounce ownership so that investors won't fear this function.
    */
    ...
    */
    ...
    function depositCollateral() public override whenNotPaused {
        ...
        _collateralToken.transferFrom(msg.sender, address(this), _params.collateralAmount);
    ...
    function retrieveCollateral() public override {
        ...
        _collateralToken.transfer(msg.sender, _params.collateralAmount);
    ...
    function finalWithdraw() public override {
        ...
        _token.transfer(_params.withdrawee, _token.balanceOf((address(this))) - (_sold - _claimed));
    ...
    function forceWithdraw(address to) public override {
        ...
        _token.transfer(to, _token.balanceOf((address(this))) - (_sold - _claimed));
